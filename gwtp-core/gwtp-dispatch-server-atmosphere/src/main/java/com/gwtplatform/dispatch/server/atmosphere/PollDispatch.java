 ...
 * client-side version is {@link PollDispatch}.
 * <p />
...
public interface PollDispatch {
   ...
   */
  <A extends Action<R>, R extends Result> void execute(A action, PollDispatchCallback callback)
   ...
   * @throws com.gwtplatform.dispatch.shared.ServiceException if the execution failed due to a service error.
   */
  <A extends Action<R>, R extends Result> void undo(A action, R result, PollDispatchCallback callback)
      throws ActionException, ServiceException;
}